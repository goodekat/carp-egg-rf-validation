...
| `Embryo_to_Membrane_Ratio` | `num` | embryo to membrane ratio
| `Embryo_Ave` | `num` | average embryo diameter (mm)
| `Embryo_SD` | `num` | embryo diameter standard deviation (mm)
| `Embryo_CV` | `num` | embryo diameter coefficient of variation (mm)
...
example_vars <-
  data.frame(
    ...
    Embryo_to_Membrane_Ratio = c(0.57986, 0.14176),
    Embryo_Ave = c(0.80777, 1.06952),
    Embryo_SD = c(0.1685, 0.1955),
    Embryo_CV = c(0.2086, 0.1828),
